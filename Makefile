...
build_generator:
	clear
	mpic++ -std=c++11 -I generator/include -o generator/lib/Generator.o -c generator/src/Generator.cpp
	mpic++ -std=c++11 -I generator/include -o generator/lib/Util.o -c generator/src/Util.cpp

	mpic++ -std=c++11 -I generator/include -o generator/bin/gen_data generator/lib/Generator.o generator/lib/Util.o generator/src/TestGenerator.cpp
